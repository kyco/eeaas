...
import DocsCodeExamples from './pages/DocsCodeExamples'
...
function App() {
  return (
    ...
    <BrowserRouter basename={import.meta.env.VITE_DOCS_BASENAME || '/'}>
      <ScrollToTop />
      <Routes>
        <Route path={ROUTES.HOME} element={<Layout />}>
          ...
          <Route path={ROUTES.DOCS__CODE_EXAMPLES} element={<DocsCodeExamples />} />
